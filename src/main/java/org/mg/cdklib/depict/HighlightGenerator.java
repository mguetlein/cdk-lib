...
/**
 * copy of final class org.openscience.cdk.renderer.generators.HighlightGenerator with adjusted radius
 */
public final class HighlightGenerator implements IGenerator<IAtomContainer>
{
	...
	public IRenderingElement generate(IAtomContainer container, RendererModel model)
	{
		...
		for (IBond bond : container.bonds())
		{
			...
			Area area = shapes.get(id);
			Shape shape = createBondHighlight(bond, radius * bondRadiusAdjust);
